...
const en = {
  ...
  settings: {
    ...
    scannerTestDesc: 'The connection test sends a tiny image to the selected provider and may use a small amount of provider credit.',
    ...
    scannerAdminSummary: 'Server configuration',
    scannerAdminSummaryDesc: 'Administrator-only overview. API keys are never shown.',
