...
const en = {
  ...
  settings: {
    ...
    pokemonCenterQueueAlerts: 'Pokemon Center Queue Alerts',
    pokemonCenterQueueAlertsDesc: 'Telegram alert when Pokemon Center appears to enter a waiting room',
    pokemonCenterQueueInterval: 'Queue Check Interval',
    pokemonCenterQueueIntervalDesc: 'Experimental monitor interval for Pokemon Center',
    pokemonCenterQueueStatus: 'Queue Monitor Status',
    pokemonCenterQueueStatusDesc: 'Experimental detector evidence for debugging real drops',
    pokemonCenterQueueCheckNow: 'Check now',
    pokemonCenterQueueLastChecked: 'Last checked',
    pokemonCenterQueueHttp: 'HTTP',
    pokemonCenterQueueUrl: 'URL',
    pokemonCenterQueueNotified: 'Notified',
    pokemonCenterQueueMessage: 'Message',
    pokemonCenterQueueCheckComplete: 'Queue check complete',
    pokemonCenterQueueCheckFailed: 'Queue check failed',
    pokemonCenterQueueReportVisible: 'Report visible queue',
    pokemonCenterQueueReportConfirm: 'Report Pokemon Center as queued and send Telegram alerts?',
    pokemonCenterQueueReportComplete: 'Queue reported',
    pokemonCenterQueueReportFailed: 'Queue report failed',
