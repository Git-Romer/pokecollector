...
const en = {
  ...
  scanner: {
    ...
    itemPending: 'Waiting to be recognized…',
    jobRunning: 'Scanning…',
    jobFailedSuffix: 'failed',
    jobProgressSuffix: 'cards recognized',
    openJobs: 'Scans in progress',
    queueHint: 'Recognition runs in the background and is paced to stay within the Gemini rate limit. You can close this and come back — results are saved.',
    markReviewed: 'Done',
    ...
    rotatePhoto: 'Rotate photo a quarter turn',
    showDetails: 'Show details',
    hideDetails: 'Collapse',
    rotateFailed: 'Could not rotate the photo',
    acceptMatch: 'Accept this card',
    previousMatch: 'Previous match',
    nextMatch: 'Next match',
    arrowKeyHint: 'Use ← → to compare',
    zoomHint: 'click or scroll to zoom both, drag to pan',
