...
const en = {
  ...
  collection: {
    ...
    ownPhotoDesc: 'Store a private photo of the actual card. Your display preference decides whether it or the catalogue image is shown first. Location and camera metadata are removed before storage.',
