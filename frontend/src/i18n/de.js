...
const de = {
  ...
  collection: {
    ...
    importReviewTitle: 'Prüfen, bevor es Wahrheit wird',
    importReviewDescription: 'Excel ist dein Arbeitsbuch. Importierte CSV-Zeilen werden hier zu Sammlungsdaten, nachdem dieser Tracker sie akzeptiert. Kostenbasis, Lagerung, Grading und Notizen sollten stimmen.',
  ...
  settings: {
    ...
    csvExport: 'Sammlung exportieren',
    csvExportDesc: 'Excel ist das Hauptformat. CSV bleibt für einfache Importe und externe Tools verfügbar.',
    exportButton: 'Export',
    exportExcelButton: 'Excel',
    exportCsvButton: 'CSV',
    localFirstTitle: 'Lokale Quelle der Wahrheit',
    localFirstDesc: 'Deine Sammlung, versiegelten Produkte, Pflegehinweise, Kostenbasis und Exporte bleiben in diesem lokalen Tracker, bis du sie selbst bewegst.',
    localFirstBadge: 'Lokal',
