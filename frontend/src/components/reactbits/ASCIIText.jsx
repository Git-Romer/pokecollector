...
class CanvAscii {
    constructor(
        {text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, animateContinuously},
        containerElem,
        width,
        height
    ) {
        ...
        this.animateContinuously = animateContinuously;
    ...
    requestRender() {
        if (this.animateContinuously || this.pendingFrame) return
    ...
    render() {
        const time = this.animateContinuously ? new Date().getTime() * 0.001 : 0;
