    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-bg-primary px-4">
            <form onSubmit={handleSubmit}
                  className="w-full max-w-md rounded-2xl border border-border bg-bg-secondary p-6 shadow-xl space-y-4">
                ...
                <div>
                    <label
                        className="text-xs text-text-secondary mb-1 block">{t('settings.users.confirmPassword')}</label>
                    <input
                        type="password"
