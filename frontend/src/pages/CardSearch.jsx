        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div>
                    ...
                    <select className="select" value={filters.subtype}
                ...
                <div>
                    ...
                    <select className="select" value={filters.rarity}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                <div>
                    ...
                    <select className="select" value={filters.series}
                ...
                <div>
                    ...
                    <select className="select" value={filters.set_id}
                            onChange={(e) => setFilter('set_id', e.target.value)}>
        ...
        <div className="space-y-4 pb-2">
            ...
            <div className="card">
                <form onSubmit={handleSearch} className="flex gap-2">
                    ...
                    <div className="flex-1 min-w-0 relative">
                        ...
                        {isCodeNumberSearch && (
                            <div
                                className="absolute right-3 top-1/2 -translate-y-1/2 hidden sm:flex items-center gap-1 text-xs text-yellow pointer-events-none">
                                <Hash size={12}/>
              ...
              {hasActiveFilters ? `${activeFilterCount} Filter` : t('cardSearch.filters')}
                        ...
                        {hasActiveFilters && (
                            <span
                                className="sm:hidden bg-brand-red text-white text-xs rounded-full w-4 h-4 flex items-center justify-center leading-none">
                {activeFilterCount}
              </span>
                        )}
                    </button>
            ...
            {data && !isLoading && (
                <>
                    {selectMode && (
                        <div
                            className="card flex flex-wrap items-center gap-2 sticky top-2 z-20 bg-bg-elevated/95 backdrop-blur">
                    ...
                    {data.data?.length === 0 ? (
                        <div className="text-center py-12 space-y-4">
                            ...
                            <button onClick={() => setShowCustomModal(true)}
                                    className="btn-ghost border-yellow/30 text-yellow hover:bg-yellow/10 mx-auto">
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            ...
                                            {imgSrc
                                                ...
                                                : <div
                                                    ...
                                                    <span
                                                        className="text-[10px] text-text-muted text-center leading-tight">{card.name}</span>
                                                </div>
                                            }
                                        </div>
                                        ...
                                        {card.owned_quantity > 0 && (
                                            <div
                                                className="absolute top-1.5 right-1.5 rounded-full bg-green/90 text-white text-[10px] font-bold px-1.5 py-0.5 shadow">
                                        ...
                                        <div className="mt-1.5 px-0.5">
                                            <div className="flex items-center gap-1">
                                                ...
                                                {card._lang && langFilter === 'all' && (
                                                    <span
                                                        className={`flex-shrink-0 text-[9px] font-black px-1 py-0.5 rounded leading-none ${tcgdexLanguageBadgeClass(card._lang)}`}>
