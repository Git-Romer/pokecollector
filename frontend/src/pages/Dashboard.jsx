        ...
        return (
            <div className="space-y-5 animate-pulse pb-4">
                ...
                <div className="rounded-2xl overflow-hidden border-2 border-gold/20"
                     style={{background: 'linear-gradient(135deg, #1a2040, #0d1530)'}}>
                    ...
                    <div className="flex gap-2.5 overflow-x-auto pb-2 no-scrollbar -mx-4 px-4">
                        {data.recent_additions.slice(0, 12).map(card => (
                            <div key={card.id} className="flex-shrink-0 w-20 group cursor-pointer"
                                ...
                                <div
                                    className="aspect-[2.5/3.5] rounded-lg overflow-hidden shadow-lg ring-1 ring-white/5 group-hover:ring-brand-red/50 group-hover:scale-[1.03] transition-all duration-150 transform-gpu origin-center">
                        ...
                        {data.top_cards.slice(0, 10).map((card, i) => (
                            <div key={card.collection_item_id || card.id}
                                ...
                                <div className="relative">
                                    <div
                                        className="aspect-[2.5/3.5] rounded-lg overflow-hidden shadow-lg ring-1 ring-white/5 group-hover:scale-[1.03] transition-all duration-150 group-hover:ring-gold/40 transform-gpu origin-center">
                                        <CardImage src={resolveCardImageUrl(card)} alt={card.name}
                                                   className="w-full h-full object-cover"/>
                                    </div>
                                    <span
                                        className="absolute top-1 left-1 bg-black/80 text-highlight text-[9px] font-black rounded px-1 leading-4">
                    #{i + 1}
                  </span>
                                </div>
