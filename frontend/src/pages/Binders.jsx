            ...
            <div>
                ...
                <div className="rounded-xl border border-border bg-bg-card p-4">
                    <div className="flex items-center gap-4">
                        ...
                        >
                            {iconPokemonId ? (
                                <img src={`${SPRITE_BASE_URL}/${iconPokemonId}.gif`} alt={`Pokemon ${iconPokemonId}`}
                                     className="max-h-20 max-w-full object-contain pixelated"/>
                            ) : (
                        ...
                        <div className="min-w-0 space-y-1">
                            ...
                            {iconPokemonId && (
                                <button type="button" onClick={() => setIconPokemonId(null)}
        ...
        <div className="space-y-4 pb-2">
            ...
            <div className="flex items-center justify-between gap-2 mb-4 flex-wrap">
                <div className="min-w-0">
                    <h1 className="text-5xl font-bold text-text-primary mag-heading uppercase leading-none mt-2">
                        <SplitText text={t('binders.title')} delay={40}/></h1>
            ...
            {creating && (
                <div className="card border-brand-red/30">
                    ...
                    <BinderForm onSubmit={(data) => createMutation.mutate(data)} onCancel={() => setCreating(false)}
                                        ...
                                        <div className="pt-2">
                                            {binder.icon_pokemon_id ? (
                                                <img src={`${SPRITE_BASE_URL}/${binder.icon_pokemon_id}.gif`} alt=""
                                                     className="max-h-10 max-w-10 object-contain mb-2 pixelated"
                                                     loading="lazy"/>
                                            ) : isWishlist ? (
