...
export const addCardToBinder = (binderId, cardId, requiredQuantity = 1) => api.post(`/binders/${binderId}/cards`, null, {
    params: {
        card_id: cardId,
...
export const switchBinderEntryCard = (binderId, binderCardId, cardId, collectionItemId = null) => api.put(`/binders/${binderId}/entries/${binderCardId}/card`, {
    card_id: cardId,
